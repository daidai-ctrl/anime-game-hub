...
export function CategoryPageContent({ category, articles, currentPage = 1 }: CategoryPageContentProps) {
  ...
  const trendingSearches = [
    'Blox Fruits Codes',
    'Anime Rangers Tier List',
    'Anime Vanguards Codes',
    'Blox Fruits Update 26',
    ...
    <div className="mx-auto max-w-7xl px-4 py-10">
      ...
      <div className="grid gap-8 lg:grid-cols-3">
        ...
        <aside className="space-y-6">
          ...
          <div className="rounded-xl bg-[#1a1d2e] border border-[#2a2d3e] p-5">
            <h3 className="font-bold text-foreground mb-4 flex items-center gap-2">
              <svg className="w-4 h-4 text-[#f59e0b]" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" /></svg>
              {t('sidebar.trendingSearches')}
            </h3>
