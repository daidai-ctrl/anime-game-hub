...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'ranking.howVotingDesc': 'Players can vote for the items they believe deserve higher rankings. As more votes are collected, the community list becomes more useful and reflects real player preferences. Votes should be based on overall usefulness, including story progression, farming, PvP, team synergy, and upgrade value.',
  ...
  zh: {
    ...
    'ranking.howVotingDesc': '玩家可以为他们认为排名应更高的项目投票。随着更多投票的收集，社区列表将更有用并反映真实的玩家偏好。投票应基于整体实用性，包括故事推进、刷图、PvP、团队协同和升级价值。',
...
'breadcrumb.home': 'ホーム',
    ...
    'ranking.howVotingDesc': 'プレイヤーは、より高いランクに値すると思うアイテムに投票できます。投票が集まるほど、コミュニティリストは有用になり、実際のプレイヤーの好みを反映します。投票は、ストーリー進行、ファーミング、PvP、チーム相性、アップグレード価値などを総合的に評価してください。',
  ...
  es: {
    ...
    'ranking.howVotingDesc': 'Los jugadores pueden votar por los artículos que creen que merecen una clasificación más alta. A medida que se recopilan más votos, la lista comunitaria se vuelve más útil y refleja las preferencias reales de los jugadores. Los votos deben basarse en la utilidad general, incluyendo progresión, farming, PvP, sinergia de equipo y valor de mejora.',
  ...
  pt: {
    ...
    'ranking.howVotingDesc': 'Os jogadores podem votar nos itens que acreditam merecer classificações mais altas. À medida que mais votos são coletados, a lista da comunidade se torna mais útil e reflete as preferências reais dos jogadores. Os votos devem ser baseados na utilidade geral, incluindo progressão, farming, PvP, sinergia de equipe e valor de upgrade.',
