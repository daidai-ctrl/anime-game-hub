...
export const games: Game[] = [
  {
    ...
    popularTopics: [
      ...
      { label: '2x EXP Codes', slug: '2x-exp-codes' },
      { label: 'Stat Reset Codes', slug: 'stat-reset-codes' },
      { label: 'Free Fruit Codes', slug: 'free-fruit-codes' },
      { label: 'Level Guide', slug: 'level-guide' },
      ...
      { label: 'PvP Guide', slug: 'pvp-guide' },
      { label: 'Community Rankings', slug: 'community-rankings', icon: '🔥' },
    ],
    faqs: [
  ...
  },
  {
    ...
    popularTopics: [
      ...
      { label: 'Codes', slug: 'codes', icon: '🔑' },
      { label: 'Best Teams', slug: 'best-teams' },
      { label: 'Value List', slug: 'value-list' },
      { label: 'Madara Guide', slug: 'madara-guide' },
      { label: 'Ichigo Guide', slug: 'ichigo-guide' },
      { label: 'Memoria Guide', slug: 'memoria-guide' },
      { label: 'Familiar Guide', slug: 'familiar-guide' },
