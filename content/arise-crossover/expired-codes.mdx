---
title: "Arise Crossover Expired Codes (2026) – All Expired Code List"
description: "Complete list of expired Arise Crossover codes for 2026. Check which codes have expired and avoid trying invalid codes."
date: "2026-05-25"
category: "codes"
game: "arise-crossover"
---

## Arise Crossover Expired Codes (2026)

This page lists all expired codes in Arise Crossover so you can avoid trying codes that no longer work. For active codes, visit our [Arise Crossover Codes](/arise-crossover/codes) page.

## All Expired Codes

| Code | Reward | Expired Date |
|------|--------|--------------|
| `ARISE2025` | 300 Crystals | 2025 |
| `WINTERCROSS` | Holiday Character Skin | 2025 |
| `LAUNCH2024` | 500 Crystals | 2024 |
| `BETA100K` | 300 Crystals + XP Boost | 2024 |
| `FREEROLLS` | 5 Summon Tickets | 2024 |
| `HOLIDAY2025` | Holiday Character Skin | 2025 |
...
- **Bookmark our [Active Codes page](/arise-crossover/codes)** — We only list working codes there
