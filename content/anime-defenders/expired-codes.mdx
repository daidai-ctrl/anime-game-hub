---
title: "Anime Defenders Expired Codes (2026) – All Expired Code List"
description: "Complete list of expired Anime Defenders codes for 2026. Check which codes have expired and avoid trying invalid codes."
date: "2026-05-25"
category: "codes"
game: "anime-defenders"
---

## Anime Defenders Expired Codes (2026)

This page lists all expired codes in Anime Defenders so you can avoid trying codes that no longer work. For active codes, visit our [Anime Defenders Codes](/anime-defenders/codes) page.

## All Expired Codes

| Code | Reward | Expired Date |
|------|--------|--------------|
| `AD2025` | 300 Gems | 2025 |
| `WINTEREVENT` | Holiday Skin | 2025 |
| `LAUNCH2024` | 500 Gems | 2024 |
| `BETA100K` | 300 Gems + XP Boost | 2024 |
| `FREEROLLS` | 5 Summon Tickets | 2024 |
| `HOLIDAY2025` | Holiday Defender Skin | 2025 |
...
- **Bookmark our [Active Codes page](/anime-defenders/codes)** — We only list working codes there
